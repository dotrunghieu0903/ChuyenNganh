...
//  }
  ...
  public void showWebViewDialog(View view) {
    ...
    public void showWebviewRecognition(View view) {
        Intent nextScreen = new Intent(getApplicationContext(), RecognitionActivity.class);
        startActivity(nextScreen);
    }

    public void showVoiceRecognitionDialog(View view) {
    Intent nextScreen = new Intent(getApplicationContext(), VoiceRecognitionActivity.class);
    startActivity(nextScreen);
    }
